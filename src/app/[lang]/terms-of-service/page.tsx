      ...
      <div className="container">
        <div style={{ maxWidth: 720, margin: '0 auto', padding: '4rem 0 6rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
            ...
            <Section title={es ? '6. Propiedad Intelectual' : '6. Intellectual Property'}>
              <p>
                {es
            ...
            <Section title={es ? '7. Disponibilidad y Modificaciones del Servicio' : '7. Service Availability and Modifications'}>
              <p>
                {es
            ...
            <Section title={es ? '8. Renuncia de Garantías' : '8. Disclaimer of Warranties'}>
              <p>
                {es
            ...
            <Section title={es ? '9. Limitación de Responsabilidad' : '9. Limitation of Liability'}>
              <p>
                {es
            ...
            <Section title={es ? '10. Terminación' : '10. Termination'}>
              <p>
                {es
            ...
            <Section title={es ? '11. Ley Aplicable' : '11. Governing Law'}>
              <p>
                {es
            ...
            <Section title={es ? '12. Contacto' : '12. Contact'}>

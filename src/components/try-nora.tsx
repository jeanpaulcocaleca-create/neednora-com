...
type Phase = 'situations' | 'nora-thinking' | 'nora-replied' | 'follow-thinking' | 'follow-replied'
...
export function TryNora({ lang }: { lang: Locale }) {
  ...
  const isThinking = phase === 'nora-thinking' || phase === 'follow-thinking'
    ...
    >
      ...
      <div className="container" style={{ position: 'relative' }}>
        ...
        <div className="tn-layout">
          ...
          <div className="tn-window">
            <div className="tn-win-header">
              <div className="tn-identity">
                ...
                <div>
                  <b>NORA</b>
                  <span>{l === 'es' ? 'Demo interactivo' : 'Interactive demo'}</span>
                </div>
              </div>
          ...
          {/* RIGHT: Situations / Follow-up choices */}
          <div className="tn-right-panel">
            <AnimatePresence mode="wait">
              ...
              {/* NORA is thinking — dim waiting state */}
              {isThinking && (
                <motion.div
                  key="thinking"
                  initial={{ opacity: 0 }}
              ...
              {/* After response with no follow-up OR after follow-up resolved */}
